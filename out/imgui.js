...
function alert_popup(string,length){ js_alert_popup(string, length); }
function canvas_get_height(){ return Module.canvas.height; }
function canvas_get_width(){ return Module.canvas.width; }
function file_dialog(){ js_file_dialog(); }
function open_data_url(string,length){ js_open_data_url(string, length); }
function open_url(string,length){ js_open_url(string, length); }
function resize_canvas(){ js_resize_canvas(); }
...
/** @type {function(...*):?} */
var ___em_js__canvas_get_width = Module["___em_js__canvas_get_width"] = createExportWrapper("__em_js__canvas_get_width");

/** @type {function(...*):?} */
var ___em_js__canvas_get_height = Module["___em_js__canvas_get_height"] = createExportWrapper("__em_js__canvas_get_height");

/** @type {function(...*):?} */
var ___em_js__resize_canvas = Module["___em_js__resize_canvas"] = createExportWrapper("__em_js__resize_canvas");

/** @type {function(...*):?} */
var ___em_js__file_dialog = Module["___em_js__file_dialog"] = createExportWrapper("__em_js__file_dialog");

/** @type {function(...*):?} */
var ___em_js__alert_popup = Module["___em_js__alert_popup"] = createExportWrapper("__em_js__alert_popup");

/** @type {function(...*):?} */
var ___em_js__open_url = Module["___em_js__open_url"] = createExportWrapper("__em_js__open_url");

/** @type {function(...*):?} */
var ___em_js__open_data_url = Module["___em_js__open_data_url"] = createExportWrapper("__em_js__open_data_url");

/** @type {function(...*):?} */
var _update_file = Module["_update_file"] = createExportWrapper("update_file");
